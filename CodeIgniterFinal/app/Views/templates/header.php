...
<body>
<header style="background-color: #dddddd">
    <div class="menu">
        <ul>
            <li class="logo">
                <img src="<?= base_url('assets/img/maravillas.jpg')?>" width="150">
            </li>
            ...
            <li class="menu-item hidden"><a href="<?= base_url('admin/loginForm') ?>"><b>Login</b></a>
                <?php endif ?>

            <?php $session = session();
            if (! empty($session->get('user'))):?>
            <li class="menu-item-hidden"><a href="<?= base_url('admin/session') ?>"><b>Cerrar sesión</b></a></li>
            <?php endif ?>
